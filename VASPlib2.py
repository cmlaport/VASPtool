...
####changestep: a number between 0 and 1, where 0 is the initial state and 1 is the final state position####
 ...
 #           final_p = periodic_boundary(periodic_check)
    final_p = periodicity_check(workingfiles)
...
#print per_change_bond(['CONTCAR','CONTCAR_finop'],0.1)
...
#                    f.writelines(line)
#    return new_file
#os.chdir('../transfer3/fin/trial2success')
#print per_neighbor_finder('POSCAR',1,4)
#print per_neighbor_finder('POSCAR',3,4)
